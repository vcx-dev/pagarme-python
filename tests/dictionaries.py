...
API_KEY = {'api_key':pagarme_test.create_temporary_company()}

VALID_CARD_DICTIONARY = {'api_key':API_KEY['api_key'],'card_number': '4242424242424242','card_cvv': '111','card_holder_name': 'Aardvark da Silva',
...
UNVALID_CREDIT_CARD_TRANSACTION_DICTIONARY = {'api_key':API_KEY['api_key'],'amount':'10000',
...
VALID_CREDIT_CARD_TRANSACTION_DICTIONARY = {'api_key':API_KEY['api_key'],'amount':'10000',
